...
class Account:
    ...
    def __init__(
        ...
        self.platform = (platform or "zhuanzhuan").strip() or "zhuanzhuan"
        self.group = (group or "default").strip() or "default"
        self.browser_instance_id = (browser_instance_id or "").strip()
    ...
    def from_dict(cls, d):
        return cls(
            ...
            platform=d.get("platform", "zhuanzhuan"),
            group=d.get("group", "default"),
            browser_instance_id=d.get("browser_instance_id", ""),
        )
...
class ProductDetail:
    ...
    def __init__(
        ...
        self.brand_id = int(brand_id or 0)
        self.model_id = int(model_id or 0)
        self.product_params = str(product_params or "")
    ...
    @property
    def settled_price(self) -> float:
        return self.settle_price

    @settled_price.setter
    def settled_price(self, value: float):
        self.settle_price = float(value or 0.0)
...
class BatchItem:
    ...
    manual_review_state: str = "none"
    manual_review_source: str = ""
    manual_review_target_action: str = ""
    manual_review_target_price: Optional[float] = None
    op_status: str = "待处理"
    op_message: str = ""
    ...
    probe_anchor_price: Optional[float] = None
    probe_last_side: str = ""
    probe_last_at: Optional[datetime] = None
    probe_day_count: int = 0
    probe_day: str = ""
    ...
    @property
    def settled_price(self) -> Optional[float]:
        return self.settle_price

    @settled_price.setter
    def settled_price(self, value: Optional[float]):
        self.settle_price = value

    @property
    def suggested_settled_price(self) -> Optional[float]:
        return self.suggested_settle_price

    @suggested_settled_price.setter
    def suggested_settled_price(self, value: Optional[float]):
        self.suggested_settle_price = value
